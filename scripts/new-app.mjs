#!/usr/bin/env node
// Scaffolds a new internal app: node scripts/new-app.mjs <slug> [--react] [--title "Name"]
...
function fail(msg) {
  ...
  console.error('Usage: node scripts/new-app.mjs <slug> [--react] [--title "Display Name"]');
  process.exit(1);
}
...
console.log(`Created apps/${slug} (${react ? 'React' : 'vanilla TS'})`);
